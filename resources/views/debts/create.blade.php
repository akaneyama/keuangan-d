        ...
        <div class="bg-white rounded-[2.5rem] p-10 shadow-xl border border-slate-100 italic">
            <form action="{{ route('debts.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="type" class="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-slate-900 shadow-inner" required>
                            <option value="debt">Saya Meminjam (Hutang)</option>
                            <option value="receivable">Orang Lain Meminjam (Piutang)</option>
                        </select>
                    </div>
                    <div>
                        <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Nama Orang/Entitas</label>
                        <input type="text" name="name" 
                               class="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-slate-900 placeholder:text-slate-300 shadow-inner"
                               placeholder="Misal: Andi, Bank BRI, dll" required autofocus>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" name="amount" 
                               class="w-full pl-14 pr-5 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-slate-900 placeholder:text-slate-300 shadow-inner"
                               placeholder="0" required>
                    </div>
                </div>

                <div>
                    <label class="block text-[10px] font-black text-slate-400 uppercase tracking-widest mb-2">Jatuh Tempo (Opsional)</label>
                ...
                <div>
                    ...
                    <textarea name="note" rows="3" class="w-full px-5 py-4 bg-slate-50 border-none rounded-2xl focus:ring-2 focus:ring-indigo-500 font-bold text-slate-900 placeholder:text-slate-300 shadow-inner" placeholder="Misal: Buat modal usaha, pinjam uang makan, dll"></textarea>
                </div>
